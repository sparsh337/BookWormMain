...
const ProductDetail = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                // Set title once product is fetched
                document.title = `${response.data.productName} | BookWorm`;
            } catch (error) {
    ...
    const renderActionButtons = () => {
        ...
        if (ownedStatus && ownedStatus.tranType === 'P') {
            return (
                <div className="p-6 rounded-xl border bg-green-500/10 text-green-500 border-green-500/20 text-center">
        ...
        if (ownedStatus && ownedStatus.tranType === 'L') {
            return (
                <div className="p-6 rounded-xl border bg-indigo-500/10 text-indigo-500 border-indigo-500/20 text-center">
        ...
        return (
            <div className="space-y-6">
                ...
                {isRented && (
                    <div className="p-4 rounded-xl border bg-orange-500/10 text-orange-500 border-orange-500/20 text-center mb-6">
                        ...
                        <Link to="/library" className="btn btn-sm btn-warning w-full justify-center text-white">
                            Go to My Library
                        </Link>
                    </div>
                )}
                ...
                <div className="p-4 bg-body rounded-xl border border-border">
                    <h4 className="font-bold text-main mb-3">Buy this Book</h4>
                ...
                {product.rentable && !isRented && (
                    <div className="p-4 bg-body rounded-xl border border-orange-200 dark:bg-orange-900/10">
                        <h4 className="font-bold text-main mb-3 dark:text-orange-400">Rent this Book</h4>
                        <div className="flex flex-col gap-3">
                            ...
                            <button
                                ...
                                className="btn w-full justify-center text-white bg-orange-600 hover:bg-orange-700"
                            >
                ...
                {product.library && !isRented && (
                    <div className="p-4 bg-body rounded-xl border border-indigo-200 dark:bg-indigo-900/10">
                        <div className="flex items-center justify-between mb-3">
                            <div>
                                <h4 className="font-bold text-indigo-900 dark:text-indigo-400">Library Collection</h4>
            ...
            <div className="container py-10">
                ...
                <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                    <div className="grid md:grid-cols-2 gap-0">
                        {/* Image Section */}
                        <div className="bg-body min-h-[100px] flex items-center justify-center p-8">
                        ...
                        <div className="p-8 md:p-12 flex flex-col">
                            <div className="mb-6">
                                ...
                                <h1 className="text-3xl md:text-4xl font-bold mt-2 mb-2 text-main">
                                    {product.productName}
                                </h1>
