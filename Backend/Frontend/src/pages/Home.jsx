...
const Home = () => {
    ...
    return (
        <div className="min-h-screen pb-20">
                ...
                <div className="container relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            ...
                            Read instantly on any device, anywhere, anytime.
                        </motion.p>
                        <motion.div
                            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
                    ...
                    >
                        <div className="relative z-10">
                            <h3 className="text-2xl font-bold text-orange-200 mb-6">Books Read 2026</h3>
            ...
            <section className="py-12 bg-body border-b border-border">
                <div className="container">
                    <div className="bg-white rounded-3xl p-8 border border-border shadow-sm relative overflow-hidden flex flex-col justify-center items-center gap-8 hover:shadow-lg transition-shadow duration-500">
                        <div className="z-10 text-center">
                            <h4 className="text-2xl font-bold text-main mb-2">Your Favorite Genres</h4>
            ...
            <section className="py-20 bg-body overflow-hidden">
                                ...
                                featuredProducts.map((product, index) => {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            className="h-full"
                                        >
                                            <ProductCard product={product} ownedStatus={owned} />
                                        </motion.div>
                                    );
                                })
                            ) : (
            ...
            <section className="bg-indigo-50 py-16 relative overflow-hidden">
                ...
                <div className="container grid md:grid-cols-3 gap-8 relative z-10">
                    {[
                        ...
                        { icon: Star, title: "Instant Access", desc: "Start reading immediately after purchase on any device." },
