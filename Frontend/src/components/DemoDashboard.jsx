        ...
        <section className="py-20 bg-gray-50 overflow-hidden relative">
            ...
            <div className="container relative z-10">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">Track Your Reading Journey</h2>
                ...
                >
                    ...
                    <motion.div variants={item} className="md:col-span-1 bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-lg transition-shadow duration-500">
                        <div className="flex justify-between items-center mb-4">
                            <h4 className="font-bold text-gray-900">Current Read</h4>
                        ...
                        <h5 className="font-bold text-center text-gray-800 text-sm mb-1">Deep Work</h5>
