...
public class OAuth2LoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        // String picture = oAuth2User.getAttribute("picture"); // Unused for now
        ...
        Customer customer = registrationRepository.findByUserMail(email).orElseGet(() -> {
            ...
            // Assign a dummy password (ensure you have a way to handle this, e.g., allow
            // null or special flag)
            // Or generate a strong random string
            newCustomer.setPassword(passwordEncoder.encode("google_auth_dummy_password"));
            // newCustomer.setProfileImage(picture); // Make sure Customer model has this
            // field or handle it
        ...
        // Generate JWT
        String token = jwtUtil.generateToken(customer.getUserMail(), customer.getRole()); // Assumed method signature
                                                                                          // matches
